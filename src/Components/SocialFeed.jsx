    ...
    <>
      ...
      <section className="left-soc-feed-nav-box">
        ...
        <div className="soc-feed-list">
          <button
            onClick={() => socFeedBtnFunc(1)}
            className={
              socFeedBtn === 1
                ? "soc-feed-li-bx socfeedactive"
                : "soc-feed-li-bx"
            }
          >
