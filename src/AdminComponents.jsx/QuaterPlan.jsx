...
const QuaterPlan = ({onClickCloseQuaterly}) => {
  return (
    <>

    <section className="indi-plan-form-comp" onClick={onClickCloseQuaterly}>
...
<div className="admin-login-fild">
        <label htmlFor="planname">Plan C (Quaterly) </label>
