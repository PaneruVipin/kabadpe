      ...
      <section className="all-prod-admin-comp">
        <div className="top-prod-filter-flex-box">
          <div className="breadcrum-main-box">
            <h6>
              {" "}
              All <span className="num-brck"> (2,346) </span>{" "}
            </h6>
            <h6>
              {" "}
              Processing <span className="num-brck"> (1,311) </span>{" "}
            </h6>
            <h6>
              {" "}
              On hold <span className="num-brck"> (112) </span>{" "}
            </h6>
            <h6>
              {" "}
              Completed <span className="num-brck"> (1,456) </span>{" "}
            </h6>
            <h6>
              {" "}
              Refunded <span className="num-brck"> (4) </span>{" "}
            </h6>
            <h6>
              {" "}
              Failed <span className="num-brck"> (2) </span>{" "}
            </h6>
          </div>
          ...
          <div className="right-prod-search-flex-bx">
            ...
            <button className="search-prod-btn">Search Orders</button>
          </div>
        </div>
