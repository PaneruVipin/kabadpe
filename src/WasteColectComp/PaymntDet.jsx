...
const PaymntDet = ({ onclickCloseAll }) => {
  return (
    <>
      <section
        className="paymnt-det-comp sucesfuly-trnsctin-comp"
        ...
        <div className="paymnt-det-bx" onClick={(e) => e.stopPropagation()}>
          ...
          <div className="debted-form">
            ...
            <div className="bank-infoo">
              <h6>XXXXXXX5734</h6>
              <p>
                UTR: <span>441611091156</span>{" "}
              </p>
            </div>
            <div className="pricee-t">₹64</div>
          </div>
          ...
          <div className="bank-btns-flex">
            ...
            <button className="submit-otp">Share Receipt</button>
          </div>
