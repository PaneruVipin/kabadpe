    ...
    <>
          ...
          <div className="waste-sip-list">
            ...
            <li>
              <p>
                ...
                you can [specify whether you would like to receive direct
                marketing communications and limit the publication of your
            ...
            <li>
              <p>
                ...
                &quot;our&quot; refer to [data controller name]. [ For more
      ...
      <section className="serv-comp-one">
        <div className="comon-container-2">
          <div className="full-text ">
            <p className="mb-4">
              CLIMSTRIPE SHIFT PRIVATE LIMITED operates waste management under
              the brand KabadPe and the Website Name https://www.kabadpe.com,
              which provides the SERVICE.
            </p>
            <p className="mb-4">
              KabadPe has created this privacy policy in order to demonstrate
              ...
              KabadPes websites (“Sites”), mobile applications, the delivery of
              our services, and other interactions with you. Please note that
              when you access any external links from KabadPes Sites (including
              any KabadPe subsidiary Sites), such external websites may have
              different privacy policies from the Sites and ClimStripe Shift
              Pvt. Ltd. is not responsible for the privacy practices of such
              external websites. We encourage you to read all privacy policies
              posted on the web sites that you visit.
            </p>
            <p className="mb-4">
            ...
            <p className="mb-4">
              ...
              our Terms and Conditions, which is accessible at Website URL,
      ...
      <section className="serv-comp-one">
        <div className="comon-container-2">
          ...
          <div className="full-text ">
            <h3 style={{ paddingInline: "2rem" }}>LOG DATA</h3>
            <p>
          ...
          <div className="full-text ">
            <h3 style={{ paddingInline: "2rem" }}>COOKIES</h3>
            <p>
          ...
          <div className="full-text ">
            <h3 style={{ paddingInline: "2rem" }}>SERVICVE PROVIDERS</h3>
            <p>
              ...
              • To assist us in analysing how our Service is used. We want to
          ...
          <div className="full-text ">
            <h3 style={{ paddingInline: "2rem" }}>SECURITY</h3>
            <p>
          ...
          <div className="full-text ">
            <h3 style={{ paddingInline: "2rem" }}>LINKS TO OTHER SITES</h3>
            <p>
          ...
          <div className="full-text ">
            <h5 style={{ paddingInline: "2rem" }}>Children&#39;s Privacy</h5>
            <p>
          ...
          <div className="full-text ">
            <h3 style={{ paddingInline: "2rem" }}>CONTACT US PRIVACY POLICY</h3>
            <p>
