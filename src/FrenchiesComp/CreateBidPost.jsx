          ...
          <div className="bid-post-grid-bx">
            ...
            <div className="left-product-bid-det-bx">
              ...
              <div className="product-det-comn-bx">
                ...
                <div className="prod-det-text-bx">
                  <textarea name="desc" id="desc" cols="30" rows="5" placeholder="Product Description"></textarea>
                </div>
            ...
            <div className="left-product-bid-det-bx ">
              ...
              <div className="product-det-comn-bx">
                <div className="prod-det-comn-grid-form-bx">
                <div className="prod-det-form-bx">
                  <input type="number" name="productname" id="productname" placeholder="Product Quantity" />
                  </div>
            ...
            <div className="left-product-bid-det-bx">
              ...
              <div className="prod-det-comn-grid-form-bx">
                ...
                <div className="prod-det-form-bx prod-det-form-bx-unitprice">
                  <input type="number" name="price" id="price" placeholder="Per unit price" />
                  </div>
                  ...
                  <div className="same-com-add-bx mt-3">
                  <div className="check-bxx">
                  <input class="form-check-input" checked={isChecked} onChange={handleCheckBox} type="checkbox" value="" id="flexCheckDefault"   />
                  </div>
            ...
            <div className="left-product-bid-det-bx">
              ...
              <div className="same-com-add-bx ">
                  ...
                  <div className="prod-det-comn-grid-form-bx">
                <div className="prod-det-form-bx ">
                  <input type="text" name="targetcountry" id="targetcountry" placeholder="Target Country" formNoValidate />
                  </div>
