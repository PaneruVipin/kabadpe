    ...
    <section className="vend-orders-comp">
        ...
        <div className="order-filter-grid">
            ...
            <div className="ord-filt-bx">
                <input type="text" name='searchname' id='searchname' placeholder='Search by Customer Name' />
            </div>
            ...
            <button className="filt-ord-btn">
                Download All Orders <ion-icon name="cloud-download-outline"></ion-icon>
            </button>
        ...
        <div className="ord-filt-bx">
            ...
            <button className="filt-ord-btn filt-ord-btn3">
                Reset 
            </button>
