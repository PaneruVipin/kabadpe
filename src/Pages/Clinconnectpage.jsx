  ...
  return (
    ...
    <section className="clim-connect-comp">
        ...
        <div className="clim-conect-side-menu-list-bx">
          ...
          <li onClick={() => setClimConnectMenu('contribution')} className={climConnectMenu === 'contribution' ? 'clim-connect-menu-btn climconectmenuactive' : 'clim-connect-menu-btn' }>
            <FaGlobeAmericas className="clim-icon" />
            <span>My Contribution</span>
          </li>

          <li onClick={() => setClimConnectMenu('campaign')} className={climConnectMenu === 'campaign' ? 'clim-connect-menu-btn climconectmenuactive' : 'clim-connect-menu-btn' }>
            <FaGlobeAfrica className="clim-icon" />
            <span>My Campaign</span>
          </li>

          <li onClick={() => setClimConnectMenu('message')} className={climConnectMenu === 'message' ? 'clim-connect-menu-btn climconectmenuactive' : 'clim-connect-menu-btn' }>
            <BiMessageDetail className="clim-icon" />
            <span>Message</span>
          </li>

          <li onClick={() => setClimConnectMenu('folowing')} className={climConnectMenu === 'folowing' ? 'clim-connect-menu-btn climconectmenuactive' : 'clim-connect-menu-btn' }>
            <RiUserFollowFill className="clim-icon" />
            <span>Following</span>
          </li>

          <li onClick={() => setClimConnectMenu('profile')} className={climConnectMenu === 'profile' ? 'clim-connect-menu-btn climconectmenuactive' : 'clim-connect-menu-btn' }>
            <FaUserTag className="clim-icon" />
            <span>Profile</span>
          </li>

          <li onClick={() => setClimConnectMenu('notification')} className={climConnectMenu === 'notification' ? 'clim-connect-menu-btn climconectmenuactive' : 'clim-connect-menu-btn' }>
