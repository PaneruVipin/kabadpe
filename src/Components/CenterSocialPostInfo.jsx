    ...
    <>
                  ...
                  <LightGallery speed={500} plugins={[lgThumbnail, lgZoom]}>
                    {descImages.map((path) => (
                      <a href={path} className="soc-post-img">
                        <img
                          style={{
                            width: descImages.length > 1 ? "16rem" : "100%",
                            height: descImages.length > 1 ? "10rem" : "15rem",
                          }}
                          src={path}
                          alt=""
                        />
      ...
      <a href="/images/customImg/blog-4.jpg" className="soc-post-img">
        ...
        <div
          ...
          className={
            clickpopupBx
              ? "popup-clik-box popup-clik-box2 popupclickbxhide"
              : "popup-clik-box popup-clik-box2"
          }
        >
