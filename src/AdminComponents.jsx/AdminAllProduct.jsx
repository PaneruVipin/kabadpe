      ...
      <section className="all-prod-admin-comp">
        <div className="top-prod-filter-flex-box">
          <div className="breadcrum-main-box">
            <h6>
              {" "}
              All <span className="num-brck"> (446) </span>{" "}
            </h6>
            <h6>
              {" "}
              Published <span className="num-brck"> (432) </span>{" "}
            </h6>
            <h6>
              {" "}
              Drafts <span className="num-brck"> (4) </span>{" "}
            </h6>
            <h6>
              {" "}
              Bin <span className="num-brck"> (467) </span>{" "}
            </h6>
            <h6>
              {" "}
              Banned <span className="num-brck"> (132) </span>{" "}
            </h6>
          </div>
