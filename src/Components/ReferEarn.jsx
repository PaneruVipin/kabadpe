          ...
          <div className="right-qr-box">
            <div className="right-qr-code-img">
              ...
              <div className="referall-code-box">
                ...
                <p>
                  You are on the journey of becoming eco-friendly . Now, invite
                  your friends to join the movement and earn rewards together.
                </p>
                {/* <p></p> */}
              </div>
            ...
            <div className="share-referral-friend-box">
              <div className="share-referral-friend-text-box">
                <p>
                  Refer to your friend and when they complete their first pickup
                  you win ₹50 .{" "}
                </p>
